...
<%--                    <td><a href="/kiosk/order.jsp" <c:out value="${todo.title}"/></td>--%>
                    ...
                    <td><c:out value="${kiosk.price}"/></td>
                        <!--리펙토링 방식 1 -->
<%--                    <td class="menuClass1" data-menu="${kiosk.menu}"  data-price="${kiosk.price}">--%>
<%--                        <button class="${kiosk.menuNumber}">담기1</button>--%>
<%--                    </td>--%>
                </tr>
            </c:forEach>
...
<script>
        ...
        function setLocalstorage(menu,price){
        ...
        let name1 = document.querySelector('.menuName1').addEventListener('click', () => {
            ...
            setLocalstorage(class1.dataset.menu, class1.dataset.price);
        ...
        let name2 = document.querySelector('.menuName2').addEventListener('click', () => {
            ...
            setLocalstorage(class2.dataset.menu, class2.dataset.price);
